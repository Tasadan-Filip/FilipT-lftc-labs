...
//        WriteToFile.Write("src\\SymbolTable_P1err.out", scanner_P1err.getSymbolTable().toString());
        ...
        System.out.print("ProgramTestFA syntactical analysis: ");
        String programText_ProgramTestFA = ReadFromFile.Read("src\\ProgramTestFA.txt");
        Scanner scanner_ProgramTestFA = new Scanner(programText_ProgramTestFA);
        System.out.println(AnalyzeProgram(scanner_ProgramTestFA));
        WriteToFile.Write("src\\ProgramTestFA.out", scanner_ProgramTestFA.getPif().toString());
        WriteToFile.Write("src\\ProgramTestFA.out", scanner_ProgramTestFA.getSymbolTable().toString());
    }
